...
import './predictdisease.css'; // Import the CSS file
...
const PredictDisease = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://smartfarmingbackend.onrender.com/data'); // Replace with your server URL
  ...
  return (
    <div className="disease-prediction-container">
      ...
      <h2>Past 3 Days Temperature, Humidity, and Predicted Disease</h2>
      <table className="disease-prediction-table">
        <thead>
          <tr>
            <th>Day</th>
